...
import com.sun.guestvm.attach.AttachPort;

public class GuestVMVirtualMachine extends HotSpotVirtualMachine {

    private GuestVMVirtualMachineDescriptor _vmd;

    GuestVMVirtualMachine(AttachProvider provider, String vmid, GuestVMVirtualMachineDescriptor vmd) throws AttachNotSupportedException, IOException {
        super(provider, vmid);
        _vmd = vmd;
    }
