 ...
 * 
 */
package com.sun.guestvm.net.protocol.ether;
...
public class Ether implements NetDevice.Handler {
    ...
    public Ether(NetDevice dev) {
        _debug = System.getProperty("guestvm.net.protocol.ether.Ether.debug") != null;
        _dump = System.getProperty("guestvm.net.protocol.ether.Ether.dump") != null;
        this._dev = dev;
