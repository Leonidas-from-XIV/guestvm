 ...
 * 
 */
package com.sun.guestvm.net.tftp;
...
public class TFTP {
    ...
    private static boolean debug = System.getProperty("guestvm.net.tftp.TFTP.debug") != null;

    private static final int DEFAULT_TIMEOUT = 4000;
    private static int timeout = DEFAULT_TIMEOUT;

    static {
        String ts = System.getProperty("guestvm.net.tftp.TFTP.timeout");
        if (ts != null) {
            try {
