 ...
 *
 */
package com.sun.guestvm.net.arp;
/**
...
public final class ARP extends TimerTask implements NetDevice.Handler {
    ...
    private ARP(Ether ether) {
        _ether = ether;
        _debug = System.getProperty("guestvm.net.arp.debug") != null;
        final String timeOutProperty = System.getProperty("guestvm.net.arp.maxtimeouts");
