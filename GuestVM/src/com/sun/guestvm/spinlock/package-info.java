 ...
 * The most basic concrete subclasses are in the ukernel subpackage, and delagate to the C implementation
 ...
 * The default subclass to use can be specified by a system property, "guestvm.spinlock.factory.class".
 *
 */
