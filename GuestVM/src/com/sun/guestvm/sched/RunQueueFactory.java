...
import com.sun.guestvm.sched.nopriority.*;

/**
 * An abstract Factory to create compatible threads and run queue for the GuestVM scheduler.
 *
 * @author Harald Roeck
 * @author Mick Jordan
 *
...
public abstract class RunQueueFactory {
     ...
     */
    public static final String RUNQUEUE_FACTORY_CLASS_PROPERTY_NAME = "guestvm.scheduler.runqueue.factory.class";
