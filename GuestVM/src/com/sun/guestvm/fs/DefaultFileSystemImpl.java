...
/**
 * A convenience class that provides empty implementations of some of the nio native methods
 * that do not need to be implemented for many of the GuestVM file systems.
 *
 * @author Mick Jordan
 *
 */
public abstract class DefaultFileSystemImpl implements VirtualFileSystem {
