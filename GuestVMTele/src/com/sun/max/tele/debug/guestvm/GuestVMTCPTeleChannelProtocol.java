...
public class GuestVMTCPTeleChannelProtocol extends TCPTeleChannelProtocol implements GuestVMTeleChannelProtocol {
	public GuestVMTCPTeleChannelProtocol(String host, int port) {
		super(host, port);
	}
