...
public class GuestVMNativeThread extends TeleNativeThread {

    @Override
    public GuestVMTeleDomain teleProcess() {
        return (GuestVMTeleDomain) super.teleProcess();
    }

    protected GuestVMNativeThread(GuestVMTeleDomain teleDomain, Params params) {
