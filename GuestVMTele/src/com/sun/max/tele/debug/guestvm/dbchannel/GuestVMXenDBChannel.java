...
import com.sun.max.tele.debug.guestvm.dbchannel.db.*;
import com.sun.max.tele.debug.guestvm.dbchannel.dump.*;
import com.sun.max.tele.debug.guestvm.dbchannel.tcp.*;
import com.sun.max.tele.debug.guestvm.dbchannel.xg.*;
...
public final class GuestVMXenDBChannel {
    ...
    public static synchronized void attach(GuestVMTeleDomain teleDomain, int domId) {
        ...
        try {
            ...
            channelProtocol.attach(domId, teleDomain.vm().bootImage().header.threadLocalsAreaSize, 0);
