 ...
 * {@link GuestVMDBNativeTeleChannelProtocol}, has no notion of threads or other Maxine VM abstractions. These have to be
...
public class GuestVMXGNativeTeleChannelProtocol  extends GuestVMNativeTeleChannelProtocolAdaptor {
	...
	public GuestVMXGNativeTeleChannelProtocol() {
	}
	

    public GuestVMXGNativeTeleChannelProtocol(ImageFileHandler imageFileHandler) {
