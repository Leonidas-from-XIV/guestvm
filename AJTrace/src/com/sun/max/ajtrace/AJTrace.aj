...
public abstract aspect AJTrace {
	public static final String WALLTIME_PROPERTY = "ajtrace.timing";
	public static final String CPUTIME_PROPERTY = "ajtrace.cputime";
	public static final String SYSTIME_PROPERTY = "ajtrace.systime";
	public static final String OFF_PROPERTY = "ajtrace.off";
	public static final String FLAG_ERRORS_PROPERTY = "ajtrace.flagerrors";
