...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_open(JNIEnv *env, jclass c,
...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_close0(JNIEnv *env, jclass c,
							   struct fs_import *import, int fd) {
  return guk_fs_close(import, fd);
}

JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_writeBytes(JNIEnv *env, jclass c,
							       struct fs_import *import, int fd,
...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_read(JNIEnv *env, jclass c,
...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_readBytes(JNIEnv *env, jclass c,
							      struct fs_import *import, int fd,
...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_getNumImports(JNIEnv *env, jclass c) {
...
JNIEXPORT void* JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_getImport(JNIEnv *env, jclass c, jint index) {
  struct list_head *imports = guk_fs_get_imports();
  struct list_head *entry;
...
JNIEXPORT void* JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_getPath(JNIEnv *env, jclass c,
							    struct fs_import *import) {
  return import->path;
}
...
JNIEXPORT void * JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_list(JNIEnv *env, jclass c,
							 struct fs_import *import, char *path,
...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_delete(JNIEnv *env, jclass c,
							   struct fs_import *import, char *path) {
  return guk_fs_remove(import, path);
}

JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_rename(JNIEnv *env, jclass c,
							   struct fs_import *import,
...
JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_createDirectory(JNIEnv *env, jclass c,
								    struct fs_import *import, char *path) {
  return guk_fs_create(import, path, 1, 0777);
}

JNIEXPORT int JNICALL
Java_com_sun_guestvm_fs_sg_SiblingFileSystemNatives_createFileExclusively(JNIEnv *env, jclass c,
									  struct fs_import *import,
									  char *path) {
...
void *fs_dlsym(const char *symbol) {
    if (strcmp(symbol, "Java_com_sun_guestvm_fs_console_ConsoleFileSystem_nativeWriteBytes") == 0)
